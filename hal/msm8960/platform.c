...
static const int acdb_device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_VOICE_HEADPHONES] = 9,
    [SND_DEVICE_OUT_VOICE_LINE] = 9,
    ...
    [SND_DEVICE_IN_CAMCORDER_MIC] = 11,
    [SND_DEVICE_IN_VOICE_DMIC] = 4,
    [SND_DEVICE_IN_VOICE_SPEAKER_DMIC] = 4,
    [SND_DEVICE_IN_VOICE_TTY_FULL_HEADSET_MIC] = 16,
    [SND_DEVICE_IN_VOICE_TTY_VCO_HANDSET_MIC] = 36,
    [SND_DEVICE_IN_VOICE_TTY_HCO_HEADSET_MIC] = 16,
    [SND_DEVICE_IN_VOICE_REC_MIC] = 11,
    /* TODO: Update with proper acdb ids */
    [SND_DEVICE_IN_VOICE_REC_DMIC] = 11,
    [SND_DEVICE_IN_VOICE_REC_DMIC_FLUENCE] = 11,
